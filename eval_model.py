...
def evaluate_model(args):
    ...
    for step in range(start_iter, max_iter):
        ...
        #     # visualization block
              if args.type == 'point':
                  visualizer.render_point_cloud(predictions, output_path='results/q2_5_'+str(step)+'_12500_pred.gif')
                  visualizer.render_mesh(mesh_gt, output_path='results/q2_5_'+str(step)+'_12500_gt.gif')
                  img.save('results/q2_5_'+str(step)+'_12500_img.png')
